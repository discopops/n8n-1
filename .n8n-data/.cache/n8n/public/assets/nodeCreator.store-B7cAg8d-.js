...
import { m as require_get, v as require_toString, y as require__arrayMap } from "./src-SPA_8e-g.js";
import { B as subcategorizeItems, C as useNodeTypesStore, D as finalizeItems, F as prepareCommunityNodeDetailsViewStack, Ft as useNDVStore, L as searchNodes, M as groupItemsInSections, Mt as useTelemetry, N as isAINode, O as flattenCreateElements, Or as v4_default, Q as require_upperFirst, Qr as CanvasConnectionMode, T as useEvaluationStore, V as transformNodeType, Xr as isVueFlowConnection, _r as useCanvasStore, bc as STORES, ds as useSettingsStore, et as require__createCompounder, gr as useExternalHooks, k as getAiTemplatesCallout, ki as getThemedValue, mn as useTemplatesStore, r as useUIStore, s as useWorkflowsStore, z as sortNodeCreateElements } from "./users.store-CSEBKSQV.js";
import { $ as AI_CATEGORY_MEMORY, $t as EMAIL_SEND_NODE_TYPE, Ai as require__arrayIncludes, At as AGGREGATE_NODE_TYPE, Bt as COMPRESSION_NODE_TYPE, Cn as MANUAL_TRIGGER_NODE_TYPE, Co as require__SetCache, Dt as TRANSFORM_DATA_SUBCATEGORY, Ea as isCommunityPackageName, En as MERGE_NODE_TYPE, Et as TEMPLATE_CATEGORY_AI, F as CUSTOM_API_CALL_KEY, Gt as CRYPTO_NODE_TYPE, J as AI_CATEGORY_CHAINS, Jt as DATETIME_NODE_TYPE, Kn as REMOVE_DUPLICATES_NODE_TYPE, Lt as CHAT_TRIGGER_NODE_TYPE, Nt as AI_TRANSFORM_NODE_TYPE$1, Ot as TRIGGER_NODE_CREATOR_VIEW, Q as AI_CATEGORY_MCP_NODES, Qn as SET_NODE_TYPE, Qt as EMAIL_IMAP_NODE_TYPE, So as require__cacheHas, St as OTHER_TRIGGER_NODES_SUBCATEGORY, Vt as CONVERT_TO_FILE_NODE_TYPE, Wa as NodeConnectionTypes, X as AI_CATEGORY_EMBEDDING, Xa as AI_TRANSFORM_NODE_TYPE, Xt as EDIT_IMAGE_NODE_TYPE, Y as AI_CATEGORY_DOCUMENT_LOADERS, Yn as SCHEDULE_TRIGGER_NODE_TYPE, Z as AI_CATEGORY_LANGUAGE_MODELS, Zi as getNodeInputs, _t as FLOWS_CONTROL_SUBCATEGORY, ai as require__baseFlatten, an as EXTRACT_FROM_FILE_NODE_TYPE, at as AI_CATEGORY_TOOLS, bn as LIMIT_NODE_TYPE, br as XML_NODE_TYPE, bt as HUMAN_IN_THE_LOOP_CATEGORY, cn as FORM_TRIGGER_NODE_TYPE, dn as HTML_NODE_TYPE, dt as AI_SUBCATEGORY, fn as HTTP_REQUEST_NODE_TYPE, ft as AI_UNCATEGORIZED_CATEGORY, gt as DEFAULT_SUBCATEGORY, ht as CORE_NODES_CATEGORY, in as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, ir as SPLIT_OUT_NODE_TYPE, it as AI_CATEGORY_TEXT_SPLITTERS, jt as AI_CODE_NODE_TYPE, ki as require__arrayIncludesWith, lt as AI_NODE_CREATOR_VIEW, mn as IF_NODE_TYPE, mr as WEBHOOK_NODE_TYPE, nt as AI_CATEGORY_RETRIEVERS, on as FILTER_NODE_TYPE, ot as AI_CATEGORY_VECTOR_STORES, pt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, q as AI_CATEGORY_AGENTS, qn as RSS_READ_NODE_TYPE, qt as DATA_TABLE_NODE_TYPE, ro as EVALUATION_TRIGGER_NODE_TYPE, rr as SPLIT_IN_BATCHES_NODE_TYPE, rt as AI_CATEGORY_ROOT_NODES, sr as SUMMARIZE_NODE_TYPE, st as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, tt as AI_CATEGORY_OUTPUTPARSER, ut as AI_OTHERS_NODE_CREATOR_VIEW, vt as HELPERS_SUBCATEGORY, wn as MARKDOWN_NODE_TYPE, wt as REGULAR_NODE_CREATOR_VIEW, xt as NODE_CREATOR_OPEN_SOURCES, yt as HITL_SUBCATEGORY, zt as CODE_NODE_TYPE } from "./constants-BCpQwEVD.js";
import { T as require__baseUnary, r as require__baseRest, u as require_isArrayLikeObject } from "./merge-CzlYFyOF.js";
import { A as defineStore } from "./_baseOrderBy-CFCRztYo.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-CV4tJ8Ua.js";
