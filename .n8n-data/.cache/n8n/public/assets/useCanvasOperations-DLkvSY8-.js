...
import { M as useLocalStorage, S as useClipboard, vt as useI18n } from "./_MapCache-D8TcGee-.js";
import { Bt as useRoute, Kt as require_markdown_it_link_attributes, Qt as createEventBus, Vt as useRouter } from "./src-SPA_8e-g.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { C as useNodeTypesStore, Cn as doRectsOverlap, Dt as useTagsStore, Ft as useNDVStore, It as injectWorkflowState, Jr as isValidNodeConnectionType, Lt as useWorkflowState, Mt as useTelemetry, Or as v4_default, Qr as CanvasConnectionMode, Tr as usePostHog, Xi as isPresent, _n as CONFIGURATION_NODE_SIZE, _r as useCanvasStore, bn as GRID_SIZE, ci as RemoveConnectionCommand, d as isChatNode, di as ReplaceNodeParametersCommand, ds as useSettingsStore, ei as CanvasNodeRenderType, gr as useExternalHooks, hn as CONFIGURABLE_NODE_SIZE, jn as getNodesGroupSize, jt as useNodeHelpers, kn as getNewNodePosition, li as RemoveNodeCommand, ln as useFocusPanelStore, mn as useTemplatesStore, mr as useToast, ni as AddConnectionCommand, nt as useCredentialsStore, r as useUIStore, ri as AddNodeCommand, s as useWorkflowsStore, si as MoveNodeCommand, st as useDataSchema, ta as tryToParseNumber, ti as useHistoryStore, ui as RenameNodeCommand, vn as DEFAULT_NODE_SIZE, wn as generateOffsets, wt as useWorkflowHelpers, xn as PUSH_NODES_OFFSET, y as getExecutionErrorToastConfiguration, yn as DEFAULT_VIEWPORT_BOUNDARIES, zt as useProjectsStore } from "./users.store-CSEBKSQV.js";
import { $i as getNodeParameters, Bs as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ea as isCommunityPackageName, Oi as require__baseUniq, Qi as getNodeOutputs, Rs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ta as deepCopy, Tn as MCP_TRIGGER_NODE_TYPE, Vo as VIEWS, Vs as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Wa as NodeConnectionTypes, Xi as getConnectionTypes, Zi as getNodeInputs, cn as FORM_TRIGGER_NODE_TYPE, fr as UPDATE_WEBHOOK_ID_NODE_TYPES, hc as NDV_IN_FOCUS_PANEL_EXPERIMENT, ia as getSubworkflowId, mr as WEBHOOK_NODE_TYPE, or as STICKY_NODE_TYPE, qi as generateNodesGraph, uc as CANVAS_ZOOMED_VIEW_EXPERIMENT, wc as EnterpriseEditionFeature, yi as require_cloneDeep, zs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE } from "./constants-BCpQwEVD.js";
import { A as defineStore, r as useRootStore } from "./_baseOrderBy-CFCRztYo.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-CV4tJ8Ua.js";
import { t as core_default } from "./core-ClRajsjk.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-DVfi0B03.js";
import { t as VueMarkdown_default } from "./VueMarkdown-DhVYJ-Ex.js";
